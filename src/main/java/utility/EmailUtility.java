...
public class EmailUtility {
    ...
    public static void emailExtentReport(String reportPath, String reportFileName) {
        ...
        final String username = "manjunath.dinesh@ap.jll.com";
        final String password = "Jan@2022";
        ...
        try {
            ...
            message.setFrom(new InternetAddress("manjunath.dinesh@ap.jll.com"));
            message.setRecipients(Message.RecipientType.TO,
                    InternetAddress.parse("manjunath.dinesh@ap.jll.com"));
